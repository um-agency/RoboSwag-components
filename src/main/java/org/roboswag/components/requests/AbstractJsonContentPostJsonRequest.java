 ...
 */
public abstract class AbstractJsonContentPostJsonRequest<T> extends AbstractPostJsonRequest<T> {
    ...
    protected AbstractJsonContentPostJsonRequest(@NonNull final Class<T> responseResultType) {
